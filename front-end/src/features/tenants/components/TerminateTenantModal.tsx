              ...
              <div className="mb-4">
                ...
                {depositLoading ? (
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                    ...
                    <div className="text-green-600 text-sm">Current security deposit on file</div>
                  </div>
                ) : (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <div className="text-yellow-700 text-sm">No security deposit information found.</div>
                    <div className="text-yellow-600 text-xs">This tenant may not have an active contract.</div>
                  </div>
                )}
